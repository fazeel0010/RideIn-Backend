				...
				<div class="box box-info">
					...
					<!-- Stripe Section End -->
						...
						<div class="box-body" ng-init="razorpay_enabled=<?php echo e(old('razorpay_enabled',payment_gateway('is_enabled','Razorpay'))); ?>">
							...
							<div class="form-group">
								<label for="input_razorpay_name" class="col-sm-3 control-label"> Razorpay Name <em ng-show="razorpay_enabled == '1'" class="text-danger">*</em></label>
								<div class="col-md-7 col-sm-offset-1">
									<?php echo Form::text('razorpay_name', old('razorpay_name',payment_gateway('name','Razorpay')), ['class' => 'form-control', 'id' => 'input_razorpay_name', 'placeholder' => 'Razorpay Name']); ?>

									<span class="text-danger"><?php echo e($errors->first('razorpay_name')); ?></span>
								</div>
							</div>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u253503063/domains/ridein.in/public_html/uat/resources/views/admin/payment_gateway.blade.php ENDPATH**/ ?>