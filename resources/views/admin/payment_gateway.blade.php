					...
					<!-- Stripe Section End -->
						...
						<div class="box-body" ng-init="razorpay_enabled={{ old('razorpay_enabled',payment_gateway('is_enabled','Razorpay')) }}">
							...
							<div class="form-group">
								...
								<div class="col-md-7 col-sm-offset-1">
									{!! Form::text('razorpay_name', old('razorpay_name',payment_gateway('name','Razorpay')), ['class' => 'form-control', 'id' => 'input_razorpay_name', 'placeholder' => 'Razorpay Name']) !!}
									<span class="text-danger">{{ $errors->first('razorpay_name') }}</span>
								</div>
							</div>
